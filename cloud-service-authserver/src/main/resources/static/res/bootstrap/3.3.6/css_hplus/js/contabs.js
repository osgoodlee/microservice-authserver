$(function() {
	...
	function c() {
		...
		if (k) {
			var href="?frame=iframe"+m;
			if(o.indexOf('?')>0)href="&frame=iframe"+m;
			var p = '<a href="javascript:;"  class="active J_menuTab" data-id="' + o+ href + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
			$(".J_menuTab").removeClass("active");
			var n = '<iframe class="active J_iframe" id="iframe' + m + '" name="iframe' + m + '" width="100%" height="100%" src="' + o + href+ '" frameborder="0" data-id="' + o + '" seamless></iframe>';
			$(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(n);
			$(".J_menuTabs .page-tabs-content").append(p);
			$(".J_iframe").removeClass("active");
			g($(".J_menuTab.active"))
		}
		return false
	}
